...
public class Complex {
    ...
    public Complex(double real, double imaginary) {
        this.real = real;
        this.imaginary = imaginary; //corrigé
    }

    /**
     * Zero as a complex number
     */
    static Complex ZERO = new Complex(0, 0); //corrigé
    ...
    Complex subtract(Complex subtrahend) {
        return new Complex(this.real - subtrahend.real, this.imaginary - subtrahend.imaginary); //corrigé
    }
    ...
    Complex divide(Complex divisor) {
        ...
        return new Complex(
                ...
                (this.imaginary * divisor.real + this.imaginary * divisor.imaginary) / m  //corrigé
        );
    }
